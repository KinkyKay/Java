package com.company.Chapter2ElementaryProgramming.ProgrammingExcercises;

import java.util.Scanner;

public class ComputeVolumeTriangel {
    // Write a program that reads in the length of sides, of an equilateral triangle
    // Compute the area with formula area = Vierkantswortel van 3 / 4 * (lengtes van sides) int kwadraat
